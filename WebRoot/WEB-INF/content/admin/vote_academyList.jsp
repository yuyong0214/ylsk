...
<div class="content_box">
	<div class="content_tb">
	    <table class="list_table c3 f14" id="listUserTable">
	        <caption  class="caption_title"> ${academy_name} - 投票列表</caption>
	        <tbody class="c5">
		        <tr class="c3">
		            <td>投票标题</td>
		            <td>开始时间</td>
		        ...
		        <tr>
		            ...
		            <td>${v.username}</td>
		            <td>
		                <a href="vote!voteDetail.action?vote.id=${v.id}">详情</a>
		                <a href="vote!voteEdit.action?vote.id=${v.id}">修改</a>
		                <a href="vote!voteDelete.action?vote.id=${v.id}" onclick="return confirm('您确定要删除【${v.title}】吗？');">删除</a>
