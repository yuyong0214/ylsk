	...
	<div class="content_box">
		<div class="content_tb">
			<table class="list_table c3">
				<tbody class="c5 f14">
					<tr>
						<td>
							<div style="color: gray;" align="left">${faq.title }</div>
							<div align="left" style="margin-left: 80px">${faq.content }</div>
							<div align="right">发帖人：${user.realname }&nbsp;&nbsp;&nbsp;&nbsp;发表时间：${gfn:date(faq.create_time, 'yyyy-MM-dd HH:mm:ss')}</div>
						</td>
					</tr>
				</tbody>
			</table>
		...
		<div class="content_tb">
			<s:form action="faq!saveReply" enctype="multipart/form-data" method="post">
				...
				<input type="hidden" name="faq.pid" value="${faq.id}" />
				<table class="list_table c3">
					<tbody class="c5 f14">
						<tr>
							<td>回复：</td>
							<td><textarea rows="10" cols="80" name="faq.content"
							    style="resize:none;margin-left:4px" id="content"></textarea>
							</td>
						</tr>
						<tr>
							<td colspan="2">
