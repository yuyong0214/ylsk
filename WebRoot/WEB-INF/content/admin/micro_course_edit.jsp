...
<div class="content_tb">
    <s:form action="micro_course!update" enctype="multipart/form-data">
    <s:hidden name="micro.id"/>
    <table class="list_table c3">
       ...
       <tr>
        	...
        	<td>
        		<select name="micro.subject_id" class="select">
        			<c:forEach items="${subjectList }" var="list">
        				<option value="${list.id }" ${micro.subject_id eq list.id ? "selected='selected'":"" }>${list.subject_name }</option>
        			</c:forEach>
        		</select>
        	</td>
        </tr>
        ...
        <tr>
        	<td>简介</td>
        	<td>
        		<textarea rows="10" cols="50" name="micro.introduction">${micro.introduction }</textarea>
        	</td>
        </tr>
         <tr>
        	<td>图片（普通尺寸）</td>
