...
<div class="content_tb">
    ...
    <table class="list_table c3">
        ...
        <tr>
            <td>用户名</td>
            <td><s:textfield cssClass="input_2" name="user.username" disabled="true"/><span style="color: red">用户不能修改</span></td>
        </tr>
        <tr>
            <td>姓名</td>
            <td><s:textfield cssClass="input_2" name="user.realname" disabled="true"/><span style="color: red">用户不能修改</span></td>
        </tr>
        <tr>
            <td>用户类型</td>
            <td>
        ...
        <tr>
            <td>头像</td>
            <td><input cssClass="input_2" type="file" name="upload" /></td>
        </tr>
        <tr>
            <td>邮箱</td>
