...
<div class="content_box">
	<div class="content_tb">
	    <s:form action="vote!voteUpdate">
	    <table class="list_table c3">
	        <caption class="caption_title">【${academy_name}】修改投票信息</caption>
	        <input type="hidden" name="vote.academy_id" value="${vote.academy_id}"/>
	        ...
	        <tbody class="c5 f14">
		       ...
		       <tr>
		            <td>结束时间</td>
		            <td>
		            	<input id="end" name="vote.end_time" value="<fmt:formatDate value="${vote.end_time }" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate>" class="Wdate" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',minDate:'#F{$dp.$D(\'begin\')}'});" /><span class="red">*</span>
		            </td>
		        </tr>
		        <tr>
		            <td>题目类型</td>
