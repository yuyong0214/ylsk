...
<div class="content_box">
    ...
    <s:form action="academy_module!moduleUpdate" method="post" enctype="multipart/form-data">
    ...
    <input type="hidden" name="academyModule.module_type" value="${academyModule.module_type }" />
        ...
        <tr>
         ...
         <tr>
            ...
            <td>
                ...
                listKey="dict_key" listValue="dict_value" headerKey="" headerValue="--请选择--" disabled="true" />
            </td>
        </tr>
        <tr>
            <td>模块url</td>
            <td><input name="academyModule.module_url" value="${academyModule.module_url}" class="input_2" readonly="readonly"/></td>
        </tr>
         <tr>
            <td>模块编号</td>
            <td><input name="academyModule.module_no" value="${academyModule.module_no }" class="input_2" readonly="readonly"/></td>
        </tr>
        <tr>
            <td></td>
            <td>
