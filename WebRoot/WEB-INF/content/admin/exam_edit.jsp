...
<body style="background-color:#efeff8;">
	<div class="content_box">
		<div class="content_tb">
		    <s:form action="exam!update" onsubmit="return checkForm();">
		    		<input type="hidden" name="exam.class_id" value="${clazz.id}"/>
				    <input type="hidden" name="exam.id" value="${exam.id}"/>
				    <input type="hidden" name="exam.deleted" value="${exam.deleted}"/>
				    <table class="list_table c3">
				        <caption class="caption_title">【${exam.exam_name}】考试修改</caption>
				        
				        <tbody class="c5 f14">
				        <tr>
				            <td width="280px">考试名称</td>
				            <td><input class="input_2" id="exam_name" name="exam.exam_name" value="${exam.exam_name }"/><span class="red">*</span></td>
				        </tr>
				        <tr>
				            <td>开始时间</td>
				            <td>
				        ...
				        <tr>
				            <td>通过比例</td>
							<td>
								<input class="input_2" id="pass_scale" name="exam.pass_scale" value="${exam.pass_scale }" />%<span class="red">*</span>(0表示60%)					
							</td>
				        </tr>
				        <tr>
				            <td>考试时长</td>
				            <td>
				            	<input class="input_2" id="time_limit" name="exam.time_limit" value="${exam.time_limit }" />(分钟)<span class="red">*</span></td>
				        </tr>
				         <tr>
				            <td>考试次数</td>
				            <td>
				            	<input class="input_2" id="exam_times" name="exam.exam_times" value="${exam.exam_times }" /><span class="red">*</span>(0表示不限制)
				            </td>
				        </tr>
				        <tr>
				            <td>题目是否乱序</td>
				            <td>
				            	<s:radio list="#{'1':'是','0':'否'}" name="exam.question_random"></s:radio>
				        ...
				        <tr>
				            <td>选项是否乱序</td>
				            <td>
				            	<s:radio list="#{'1':'是','0':'否'}" name="exam.option_random"></s:radio>
				            	<span style="color: red">*</span>
				            </td>
				        </tr>
				        <tr>
