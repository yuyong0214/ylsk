		...
		<div class="content_tb">
			<table class="list_table c3 f14">
				...
				<span class="f14 fright"> 
                    <a href="clazz!sumEvaluateDetail.action?class_id=${class_id}">评估详情</a>
                </span>
				</caption>
				<tbody class="c5">
			        <tr>
					...
					<c:forEach items="${evaluateList}" var="list">
							<tr>
								...
								<td>${list.realname}</td>
								<td>
									<a href="clazz!evaluateDetail.action?evaluate_id=${list.id }">详情</a>
									<a href="clazz!deleteEvaluateDetail.action?evaluate_id=${list.id }&clazz_id=${list.class_id}" 
