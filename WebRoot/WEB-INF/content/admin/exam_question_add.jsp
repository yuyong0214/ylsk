...
<body style="background-color:#efeff8;">
	...
	<div class="content_box">
		<div class="content_tb">
			<form action="exam_question!save.action">
			...
			<table class="list_table c3">
				...
				<tbody class="c5 f14">
					...
					<tr>
						<td>答案</td>
						<td>
							<input class="input_2" name="question.answer" onkeyup="value=value.replace(/[^A-Za-z]/g,'')"/>
							<span class="red"> *</span>
						</td>
					</tr>
					<tr>
						<td>分值</td>
						<td>
							<input class="input_2" name="question.score" onkeyup="value=value.replace(/[^\d]/g,'')"/>
							<span class="red"> *</span>
						</td>
					</tr>
					<tr id="option1">
						<td>选项A</td>
						<td>
							<input class="input_2" name="question.values"/>
						</td>
					</tr>
					<tr id="option2">
						<td>选项B</td>
